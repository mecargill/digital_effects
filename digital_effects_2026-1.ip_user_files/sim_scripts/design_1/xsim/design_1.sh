...
#
# Script generated by Vivado on Tue Aug 25 14:46:48 -0400 2026
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_23 -L processing_system7_vip_v1_0_25 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_23 -L processing_system7_vip_v1_0_25 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:i2s_simulation:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
